...
int main() {
    ...
    // Demonstra bloqueio: enquanto bloqueado, atualizacoes sao ignoradas.
    sensor.bloquear();
    sensor.atualizarNivel(30.0);
    sensor.liberar();

    sensor.atualizarNivel(62.5);
    sensor.atualizarNivel(-10.0); // deve ser tratado como 0.0 caso negativo

    bomba.ajustarVazao(47.0);
    bomba.ajustarVazao(150.0); // deve ser limitado a 100
